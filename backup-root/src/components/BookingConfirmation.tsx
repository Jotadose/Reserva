    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="rounded-2xl border border-green-500/20 bg-green-500/10 p-8 text-center">
        ...
        <p className="text-lg text-gray-400">
          Tu cita ha sido registrada exitosamente. Recibirás un mensaje de
          confirmación a tu WhatsApp.
        </p>
      </div>
      ...
      {booking.client.notes && (
        <div className="rounded-2xl border border-gray-700 bg-gray-900/50 p-6 backdrop-blur-sm">
          ...
          <p className="rounded-lg bg-gray-800/50 p-4 text-gray-300">
            {booking.client.notes}
          </p>
        </div>
      )}
      ...
      <div className="rounded-2xl border border-green-500/20 bg-green-500/10 p-6">
        <div className="flex items-center justify-between">
          ...
          <a
            href={`https://wa.me/56912345678?text=Hola! Tengo una consulta sobre mi reserva del ${new Date(
              booking.date + "T12:00:00"
            ).toLocaleDateString("es-ES")} a las ${booking.time}`}
            target="_blank"
