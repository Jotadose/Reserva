...
export const AdminPanelProfessional: React.FC = () => {
    ...
    <div className="space-y-6">
      ...
      {(errorReservas || errorServicios || errorClientes) && (
        <Alert type="error" title="Error de Conexión" dismissible>
          <p>
            Algunos datos no se pudieron cargar. Verifica tu conexión e intenta
            nuevamente.
          </p>
        </Alert>
      )}
  ...
  const ServiciosView = () => {
    ...
    const [editingServicio, setEditingServicio] = useState<Servicio | null>(
      null
    );
            ...
            <div className="min-w-[800px]">
                ...
                {weekDays.map((day, index) => (
                  <div key={day} className="p-3 text-center">
                    ...
                    <div className="text-sm text-slate-400">
                      {new Date(
                        currentWeek.getTime() + index * 24 * 60 * 60 * 1000
                      ).getDate()}
                    </div>
                  </div>
                ))}
              ...
              {hours.map((hour) => (
                <div key={hour} className="grid grid-cols-8 gap-2 mb-2">
                  <div className="p-3 text-sm text-slate-400 text-right">
                    {hour}
                  </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatsCard
          ...
          value={`$${Math.round(
            stats.ingresosMes / (stats.clientesActivos || 1)
            ...
            {servicios?.slice(0, 5).map((servicio, index) => (
              ...
              >
                ...
                <Badge variant="primary">
                  {Math.floor(Math.random() * 50 + 10)} reservas
                </Badge>
              </div>
            ))}
          </div>
  ...
  const ConfiguracionView = () => (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-400">
          Ajustes generales y configuración de la barbería
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card padding="lg">
          ...
          <div className="space-y-4">
            ...
            <Input
              label="Email"
              placeholder="contacto@barbershop.cl"
              fullWidth
            />
            <Button variant="primary" fullWidth>
              Guardar Cambios
        ...
        <Card padding="lg">
          ...
          <div className="space-y-4">
            <Alert type="info">
              <p>
                Configurar WhatsApp Business API para notificaciones automáticas
              </p>
            </Alert>
            <div className="space-y-3">
