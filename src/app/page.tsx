        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature) => (
              <Card key={feature.title} className="text-center hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-300 border-gray-700 bg-gradient-to-br from-gray-800/50 to-slate-900/50 backdrop-blur-sm hover:scale-105 group">
                <CardHeader>
      ...
      <section id="pricing" className="py-20 px-4 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-800">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Comienza hoy y escala cuando lo necesites. Solo cobramos el plan cuando lo habilites.
            </p>
          </div>
                  ...
                  {plan.enabled ? (
                    <Link href="/pricing" className="block">
                      <Button 
                        ...
                        size="lg"
                      >
                        {plan.id === 'basic' ? '🚀 Empezar' : `🎯 Seleccionar ${plan.name}`}
                      </Button>
                    </Link>
                  ) : (
                    <Button className="w-full bg-gray-300 text-gray-500 cursor-not-allowed" size="lg" disabled aria-disabled>
                      Próximamente
                    </Button>
                  )}
                </CardContent>
