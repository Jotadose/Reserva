...
export const GestionBarberosMejorada: React.FC = () => {
  ...
  const serviciosMap = React.useMemo(() => {
    ...
    for (const s of servicios || [])
      m.set(s.id_servicio, { nombre: s.nombre, precio: s.precio });
    return m;
  }, [servicios]);
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Error desconocido al guardar el barbero";
                  ...
                  {DIAS_SEMANA.map((dia) => (
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          handleDiaChange(dia.value, e.target.checked)
                        }
                      />
                      {dia.label}
                    </label>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-32 overflow-y-auto">
                    {servicios.map((servicio: Servicio) => (
                      ...
                      >
                        ...
                        <span
                          className="truncate"
                          title={`${servicio.nombre} - $${servicio.precio}`}
                        >
                          {servicio.nombre}{" "}
